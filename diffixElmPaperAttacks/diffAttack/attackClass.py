...
class diffAttack():
    ...
    def basicAttack(self,numUnknownVals,sd,claimThresh,attackType,numSamples,
                    numIsolated,tries=10000,atLeast=100):
        print(f'''Starting attack with:
                  numUnknownVals {numUnknownVals},
                  sd {sd},
                  claimThresh {claimThresh},
        ...
        while True:
            ...
            for sample in range(numSamples):
                ...
                for unknownVal in range(numUnknownVals):
                    aidvSetLeft = self.makeAidvSet(numTries+(unknownVal*105389))
                    aidvSetRight = self.makeAidvSet(numTries+(unknownVal*105389))
                    trueCountLeft = N
                    trueCountRight = N
